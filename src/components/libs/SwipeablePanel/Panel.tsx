...
class SwipeablePanel extends Component<SwipeablePanelProps, SwipeablePanelState> {
  ...
  constructor(props: SwipeablePanelProps) {
    ...
    this._panResponder = PanResponder.create({
      onStartShouldSetPanResponder: (evt, gestureState) => (gestureState.numberActiveTouches > 1 ? false : true),
  ...
  _animateTo = (newStatus = 0) => {
    ...
    else if (newStatus === STATUS.SMALL) newY = this.state.orientation === 'portrait' ? FULL_HEIGHT - (smallPanelHeight ?? 400) : FULL_HEIGHT / 3;
